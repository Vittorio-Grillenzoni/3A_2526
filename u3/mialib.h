...
/**
 * scambia i valori di due variabili solo se la prima è maggiore della seconda e poi stampa entrambi i valori a video
 * @param int valore 1
 * @param int valore 2
 */
void maybeSwap(int _n1, int _n2);

/**
 * ritorna il numero dei divisori di un numero
 * @param int valore
 * @return Numero di divisori trovati.
*/
int divNumber(int _n);

/**
 * ritorna il numero maggiore o minore a richiesta dell'utente
 * @param int valore
